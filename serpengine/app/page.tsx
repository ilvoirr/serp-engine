  ...
  function extractGoogleUrl(link: string) {
    // If link is a DuckDuckGo redirect, extract original target as display
    try {
      ...
      // If not, just show the original link
      return link;
    } catch {
      return link;
    }
  ...
  export default function Page() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      setHasSearched(true)
      try {
        // 1. Get fast search results right away
        ...
        setShowResults(true)
        setInput('')
        // 2. At same time, request overview summary of all results
          ...
          <div className={cn(
            ...
            <div className="mx-4 my-2">
              ...
              {results.map((result, index) => {
                // New: format the link part to look like Google
                // You may update more for actual Google feel
